...
DHT_topic = 'medGuard/patient/5976397/sts'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        formLayot.addRow("Temperature",self.Weight)

        widget = QWidget(self)
        widget.setLayout(formLayot)
        self.setTitleBarWidget(widget)
        self.setWidget(widget)     
        self.setWindowTitle("Temperature Sensor")
...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        global heart_rate
        print('Next update')
        body_temp = round(random.uniform(30.0, 44.0), 1)  # טווח תקין + חום
        current_data='Body Temperature: '+str(body_temp)+'°C'
        self.connectionDock.Weight.setText(str(body_temp))
